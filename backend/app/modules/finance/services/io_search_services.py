...
def list_insertion_orders(
    ...
    *,
    ...
    return io_repository.list_insertion_orders(
        db,
        tenant_id=tenant_id,
        module_id=module_id,
        user_id=user_id,
...
def get_insertion_order_or_404(
    ...
    *,
    ...
    record = io_repository.get_insertion_order(
        db,
        tenant_id=tenant_id,
        module_id=module_id,
        io_id=io_id,
...
def list_deleted_insertion_orders(
    ...
    *,
    ...
    return io_repository.list_deleted_insertion_orders(
        db,
        tenant_id=tenant_id,
        module_id=module_id,
        pagination=pagination,
...
def get_deleted_insertion_order_or_404(
    ...
    *,
    ...
    record = io_repository.get_deleted_insertion_order(
        db,
        tenant_id=tenant_id,
        module_id=module_id,
        io_id=io_id,

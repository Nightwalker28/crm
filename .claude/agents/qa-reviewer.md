...
- design conformance when UI changed: `./scripts/check-design.sh`, the `design-rules.spec.ts` and `scroll-containers.spec.ts` browser guards, and a both-themes pass (`docs/design/design.md` §10)

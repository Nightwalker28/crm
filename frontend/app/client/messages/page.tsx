        ...
        <div className="grid gap-5 lg:grid-cols-[360px_minmax(0,1fr)]">
          ...
          <section>
            {messagesQuery.isLoading ? (
              <div className="rounded-md border border-line-default bg-surface p-8 text-center text-sm text-copy-muted">Loading messages...</div>
            ) : messagesQuery.error ? (
              ...
              <div className="rounded-md border border-line-default bg-surface p-8 text-center text-sm text-copy-muted">No quick questions yet.</div>
            ) : (
              <div className="grid gap-3">
                {messages.map((item) => (
                  <Link key={item.id} href={`/client/messages/${item.id}`} className="group rounded-md border border-line-default bg-surface p-4 transition-colors hover:border-line-strong hover:bg-surface-raised">

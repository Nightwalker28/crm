    ...
    <div className="flex flex-col gap-6 text-neutral-200">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className="rounded-md border border-neutral-800 bg-neutral-950/40 px-4 py-3">
          ...
          <div className="mt-1 text-lg font-semibold text-neutral-100">{storageUsageQuery.error ? "Unavailable" : storageUsage ? formatBytes(storageUsage.used_bytes) : "Loading"}</div>
        </div>
        <div className="rounded-md border border-neutral-800 bg-neutral-950/40 px-4 py-3">
          <div className="text-xs uppercase tracking-wide text-neutral-500">Remaining</div>
          <div className="mt-1 text-lg font-semibold text-neutral-100">{storageUsageQuery.error ? "Unavailable" : storageUsage ? formatBytes(storageUsage.remaining_bytes) : "Loading"}</div>
        </div>
        <div className="rounded-md border border-neutral-800 bg-neutral-950/40 px-4 py-3">

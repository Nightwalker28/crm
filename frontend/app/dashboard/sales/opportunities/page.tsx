...
export default function OpportunitiesPage() {
  ...
  async function changeStage(opportunityId: number, currentStage: string | null | undefined, nextStage: string) { if (currentStage === nextStage) return; try { await updateOpportunityStage(opportunityId, nextStage); toast.success("Deal stage updated."); } catch (stageError) { toast.error(stageError instanceof Error ? stageError.message : "Deal stage could not be updated."); } }

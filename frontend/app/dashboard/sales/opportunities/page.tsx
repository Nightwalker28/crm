...
export default function OpportunitiesPage() {
  ...
  return <div className="flex flex-col gap-4">
    <PageHeader variant="module" title="Deals" description="Track value, confidence, ownership, and stage movement across the sales pipeline." eyebrow={totalCount ? `${totalCount} deal${totalCount === 1 ? "" : "s"} in this view` : undefined} actions={<Button asChild><Link href="/dashboard/sales/opportunities/new"><Plus />Add deal</Link></Button>} />

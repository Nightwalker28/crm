...
- Name: automation-builder-revamp.spec.ts >> preserves module scope and supports the mobile keyboard create flow
- Location: tests/e2e/automation-builder-revamp.spec.ts:103:5

...
- Name: mail-revamp.spec.ts >> Mail composer is responsive, validates recipients, and sends through the selected mailbox
- Location: tests/e2e/mail-revamp.spec.ts:33:5

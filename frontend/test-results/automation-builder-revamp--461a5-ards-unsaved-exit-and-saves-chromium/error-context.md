...
- Name: automation-builder-revamp.spec.ts >> edits multiple steps, reorders actions, guards unsaved exit, and saves
- Location: tests/e2e/automation-builder-revamp.spec.ts:59:5

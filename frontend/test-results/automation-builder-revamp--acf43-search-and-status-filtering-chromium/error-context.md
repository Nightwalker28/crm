...
- Name: automation-builder-revamp.spec.ts >> shows a dense rules workspace with search and status filtering
- Location: tests/e2e/automation-builder-revamp.spec.ts:47:5

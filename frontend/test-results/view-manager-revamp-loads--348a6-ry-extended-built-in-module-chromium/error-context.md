...
- Name: view-manager-revamp.spec.ts >> loads view management and filter controls for every extended built-in module
- Location: tests/e2e/view-manager-revamp.spec.ts:134:5

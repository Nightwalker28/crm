...
- Products and services are first-class tenant-owned catalog modules. Website and WordPress integrations read only active public product/service records through integration keys, using public slug/SKU, public unit price, stock status/quantity where applicable, and approved media URLs.
